...
当前公开版本：`v2026.08.17.3GoogleAITK`，共 22 个分类、696 条 classical 规则。
...
| 腾讯服务直连（含腾讯云，见下） | `tencent_docs_direct_custom` | 11 | `DIRECT` | [Raw](https://raw.githubusercontent.com/MOMO0302-02/mihomo-routing-rules/release/rules/tencent_docs_direct_custom.yaml) | [CDN](https://cdn.jsdelivr.net/gh/MOMO0302-02/mihomo-routing-rules@release/rules/tencent_docs_direct_custom.yaml) |
...
| TikTok / CapCut | `tiktok_custom` | 43 | `TikTok` | [Raw](https://raw.githubusercontent.com/MOMO0302-02/mihomo-routing-rules/release/rules/tiktok_custom.yaml) | [CDN](https://cdn.jsdelivr.net/gh/MOMO0302-02/mihomo-routing-rules@release/rules/tiktok_custom.yaml) |
